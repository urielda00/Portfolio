...
export const projects: Project[] = [
	...
	},
	{
		...
		year: "2026",
		role:
			"End-to-end automation design - workflow architecture, AI integration, structured data extraction, database integration and exception handling",
		stack: [
			"Make",
			"OpenAI API",
			"Gmail",
		...
		images: [
			{
				src: "/images/projects/make1.png",
				alt: "AI order-processing workflow in Make",
			},
			{
				src: "/images/projects/make2.png",
				alt: "Make workflow integrating Gmail, OpenAI and Supabase",
			},
		],
	},
	{
